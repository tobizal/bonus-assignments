...
negative:
	...
	movdqu	uint_str, %xmm1		# move the result to int_str
	movdqu	%xmm1, int_str		

	movdqu	int_str, %xmm1		# move the double quadword to xmm1 for shift
	pslldq	$1, %xmm1		# packed shift right logical double quadword on xmm1
	movdqu	%xmm1, int_str		# store the number back
